                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
                    ...
                    <div className="space-y-6">
                        <Link href="/" className="inline-block flex flex-col items-start group">
                            ...
                            <span className="text-sm text-gold-500 dark:text-gold-400 mt-2 tracking-widest uppercase font-serif group-hover:text-gold-600 dark:group-hover:text-gold-300 transition-colors">Premium Lands</span>
                        </Link>
                    ...
                    <div className="space-y-6">
                        <h3 className="text-lg font-semibold text-text-main uppercase tracking-wider">Quick Links</h3>
                        <ul className="space-y-3 text-sm text-text-muted">
                            ...
                            <li>
                                <Link href="/plots" className="hover:text-gold-600 dark:hover:text-gold-400 transition-colors">Exclusive Plots</Link>
                            </li>
                            <li>
                    ...
                    <div className="space-y-6">
                        <h3 className="text-lg font-semibold text-text-main uppercase tracking-wider">Contact Info</h3>
                        <ul className="space-y-4 text-sm text-text-muted">
                            ...
                            <li className="flex items-center space-x-3 group">
                                ...
                                <a href="tel:+919876543210" className="hover:text-gold-600 dark:hover:text-gold-400 transition-colors">+91 98765 43210</a>
                            </li>
                            <li className="flex items-center space-x-3 group">
                                ...
                                <a href="mailto:info@thrissurplots.com" className="hover:text-gold-600 dark:hover:text-gold-400 transition-colors">info@thrissurplots.com</a>
                            </li>
                        </ul>
                    </div>
