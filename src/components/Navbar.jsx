    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <Link
            href="/"
            className="relative z-50 group flex flex-col items-center"
          >
            ...
            <span className="text-[10px] text-gold-400 tracking-widest uppercase mt-1 font-serif group-hover:text-gold-300 transition-colors">
              Premium Lands
            </span>
          </Link>
              ...
              {NAV_LINKS.map((link, i) => (
                ...
                >
                  <Link
                    ...
                    className={`text-3xl font-serif transition-colors ${pathname === link.href ? "text-gold-400" : "text-white"} hover:text-gold-300`}
                  >
                    {link.name}
                  </Link>
                </motion.li>
