                ...
                <div className="p-6 flex flex-col flex-grow relative z-10 bg-gradient-to-t from-primary to-secondary">
                    ...
                    <div className="flex items-center justify-between py-4 border-y border-border-subtle mb-6">
                        ...
                        <div className="text-right">
                            <span className="block text-xs uppercase tracking-wider text-text-muted font-semibold mb-0.5">Value</span>
                            <span className="text-lg font-serif font-bold text-transparent bg-clip-text bg-gradient-to-r from-gold-600 to-gold-400 dark:from-gold-300 dark:to-gold-500 whitespace-nowrap">
                                {plot.price}
                            </span>
                        </div>
                    </div>
